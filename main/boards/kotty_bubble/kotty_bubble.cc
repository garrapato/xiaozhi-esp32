...
class KottyBubble : public WifiBoard {
private:
    ...
    static void touchpad_timer_callback(void* arg) {
        auto* board = static_cast<KottyBubble*>(arg);
...
public:
    KottyBubble() : boot_button_(BOOT_BUTTON_GPIO) {
